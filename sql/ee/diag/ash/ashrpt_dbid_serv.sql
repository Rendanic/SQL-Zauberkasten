...
-- Parameter 6: Service for addional filter
--
...
column name_hash new_value name_hash noprint
select NAME_HASH name_hash 
from gv$services a
where upper(name) = upper('&6')
and inst_id = &4;

column spoolfile new_value spoolfile noprint
select '&5.&1._ashrpt_&2._&3._&4._&6..txt' spoolfile from dual;
