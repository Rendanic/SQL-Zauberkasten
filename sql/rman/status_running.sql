...
-- $Id: status_running.sql 30 2010-01-12 20:58:11Z oracle $
--
-- list last 250 entries from v$rman_status
--
set pages 100
set lines 120
set verify off
...
select lv, to_char(start_time, 'dd.mm.yy HH24:mi') stime
...
from (
      ...
      from (
            ...
            from (
                  ...
                  start with parent_recid is null and status = 'RUNNING'
